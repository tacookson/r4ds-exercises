...
So `stroke` changes the width of the border, but only for shapes that have a border (like shape 21 -- a blue circle with a black border). Let's look at two examples with different `stroke` values to illustrate what `stroke` does.
